    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Book your bus tickets in just a few clicks with our intuitive interface.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Travel Community</h3>
              <p className="text-gray-600">Connect with fellow travelers, share experiences, and get travel tips.</p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">Your safety is our priority with verified operators and secure payments.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-primary-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Join thousands of travelers who trust TravelCircles for their bus travel needs.</p>
          <Link
            href="/routes"
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">TravelCircles</h3>
              <p className="text-gray-400">Making bus travel across India social and enjoyable.</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Quick Links</h4>
              <ul className="space-y-2">
                <li><Link href="/routes" className="text-gray-400 hover:text-white">Routes</Link></li>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">&copy; 2024 TravelCircles. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
